<template>
    <view class="content">
        <view @tap="onPageTap('../user-info/userinfo')" class="header" v-bind:class="{'status':isH5Plus}"
              :style='{"backgroundColor":"#d24a32","height":"200rpx"}'>
            ...
            <view class="setting" :style='{"color":"#f06f4f","fontSize":"40rpx"}'>
        ...
        <view class="list">
              ...
              <view  @tap="onPageTap('../recharge/recharge')"
                     :style='{"backgroundColor":"#f06f4f","borderColor":"#d24a32","lineHeight":"80rpx","borderStyle":"solid","borderWidth":"0 0 1rpx  0"}'
			...
			<view @tap="onPageTap('../forum/forum-my')"
                  :style='{"backgroundColor":"#f06f4f","borderColor":"#d24a32","lineHeight":"80rpx","borderStyle":"solid","borderWidth":"0 0 1rpx  0"}'
                  class="li" hover-class="hover">
                <view class="text" :style='{"color":"#fff","fontSize":"28rpx"}'>我的发贴</view>
                <!-- <image class="to" :style='{"color":"#fff","fontSize":"28rpx"}' src="/static/center/to.png"></image> -->
                <view class="cuIcon-right" :style='{"color":"#fff","fontSize":"28rpx"}'></view>
            </view>
