...
<script>
	export default {
		...
		methods: {
			...
			// 获取详情
			async init() {
				let res = await this.$api.info('shangpinCommentback', this.id);
				this.detail = res.data;
				// 主图
				this.swiperList = this.detail.shangpinCommentbackPhoto ? this.detail.shangpinCommentbackPhoto.split(",") : [];
			},
